...
public class FrmMantConcepto extends javax.swing.JInternalFrame {
    ...
    private void btnBuscaxCodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscaxCodActionPerformed
        try{
            Connection cn = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/sin", "root", "informaticdv2016");
            PreparedStatement pst = (PreparedStatement) cn.prepareStatement("select * from concepto where codigo_concepto = ?");
            pst.setString(1, txtBuscaxCod.getText().trim());
            ResultSet rs = pst.executeQuery();
            
            if(rs.next()){
                txtCodCon.setText(rs.getString("codigo_concepto"));
    ...
    private void btnBajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBajaActionPerformed
        ...
        try {
             java.sql.Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/sin", "root", "informaticdv2016");
